...
/***/ "./resources/js/Elements/AddToCart.js":
/*!********************************************!*\
  !*** ./resources/js/Elements/AddToCart.js ***!
  \********************************************/
...
var AddToCart = /*#__PURE__*/function () {
  ...
  _createClass(AddToCart, [{
    key: "publishProductAdded",
    value: function publishProductAdded() {
    ...
    key: "updateCartLink",
    value: function updateCartLink(token) {
      var routeLink = document.querySelector('.cart-menu-item').getAttribute('href');
      var cartlinkRoute = routeLink.split('?')[0].trim();
      document.querySelector('.cart-menu-item').setAttribute('href', cartlinkRoute + '?token=' + token);
    }
  }, {
    key: "__addEventListener",
    value: function __addEventListener() {
      var _this = this;

      this.addToCart.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var res, token, config;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _request__WEBPACK_IMPORTED_MODULE_1__["default"].post('/cart/store', {
                  token: _this.token,
              ...
              case 3:
                ...
                if (!_this.token) {
                  ...
                  _this.updateCartLink(token);
                }

                _this.publishProductAdded();
              ...
              case 10:
                ...
                toastify_js__WEBPACK_IMPORTED_MODULE_2___default()(_objectSpread({}, config)).showToast();
...
/***/ "./resources/js/Elements/CartMenuItem.js":
/*!***********************************************!*\
  !*** ./resources/js/Elements/CartMenuItem.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CartMenuItem = /*#__PURE__*/function () {
  function CartMenuItem() {
    _classCallCheck(this, CartMenuItem);
  ...
  _createClass(CartMenuItem, [{
    key: "increaseCount",
    value: function increaseCount() {
      var domCount = parseInt(this.domCountRef.innerHTML, 10);
      +domCount, _readOnlyError("domCount");
    ...
    key: "syncCart",
    value: function () {
      var _syncCart = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var cartToken, res, config;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _request__WEBPACK_IMPORTED_MODULE_1__["default"].post('/cart/count', {
                  token: cartToken
                });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CartMenuItem);

/***/ }),

/***/ "./resources/js/Elements/ProductSlider.js":
/*!************************************************!*\
  !*** ./resources/js/Elements/ProductSlider.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/Elements/ProductSpinner.js":
/*!*************************************************!*\
  !*** ./resources/js/Elements/ProductSpinner.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ProductSpinner = /*#__PURE__*/function () {
  ...
  _createClass(ProductSpinner, [{
    key: "publishChanges",
    value: function publishChanges(val) {
    ...
    value: function addIncreementListener() {
      ...
      this.increment.addEventListener('click', function () {
        var currentValue = _this.counterField.value;

        if (!currentValue) {
          _this.counterField.value = '1';
        }

        if (currentValue) {
          var currentParsedValue = parseInt(currentValue, 10);
          currentParsedValue++;
          _this.counterField.value = currentParsedValue;
        }

        _this.publishChanges(parseInt(_this.counterField.value, 10));
      });
    }
  }, {
    ...
    value: function removeIncreementListener() {
      ...
      this.decrement.addEventListener('click', function () {
        var currentValue = _this2.counterField.value;

        if (!currentValue) {
          _this2.counterField.value = '1';
        }
        ...
        if (currentValue) {
          ...
          _this2.counterField.value = currentParsedValue;
        }

        _this2.publishChanges(parseInt(_this2.counterField.value, 10));
      });
    }
  }, {
    ...
    value: function counterFieldListener() {
      ...
      this.counterField.addEventListener('keyup', function (e) {
        if (!(/^[0-9]*$/.test(_this3.counterField.value) && _this3.counterField.value != "0")) {
          if (_this3.counterField.value.length > 0) {
            _this3.counterField.value = _this3.counterField.value.substring(0, _this3.counterField.value.length - 1);
          }
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProductSpinner);

/***/ }),

/***/ "./resources/js/Elements/Search.js":
/*!*****************************************!*\
  !*** ./resources/js/Elements/Search.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Search = /*#__PURE__*/function () {
  ...
  _createClass(Search, [{
    ...
    key: "registerCancelSearchButtonListener",
    value: function registerCancelSearchButtonListener() {
      var _this = this;

      this.cancelButton.addEventListener('click', function () {
        _this.searchContainer.innerHTML = '';

        _this.searchOverlay.classList.remove('d-block');

        _this.searchOverlay.classList.add('d-none');
      });
    }
  }, {
    key: "registerSearchButtonListener",
    value: function registerSearchButtonListener() {
      var _this2 = this;

      this.search.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var res, products, html;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _request__WEBPACK_IMPORTED_MODULE_1__["default"].post(_this2.searchRoute, {
                  search: _this2.searchInput.value,
                  _token: _this2.csrfToken
                });

              case 3:
                res = _context.sent;
                products = res.data.products;
                html = products.reduce(function (html, product) {
                  html = "\n                        ".concat(html, "\n                        <div class=\"col-sm-12\">\n                            <a href=\"").concat(_this2.productDetailRoute.replace(/slug/, product.slug), "\">").concat(product.product_name, "</a> - $").concat(product.price, "\n                        </div>\n                        ");
                  return html;
                }, '');
                _this2.searchContainer.innerHTML = '';

                if (html) {
                  _this2.searchContainer.innerHTML = html;
                } else {
                  _this2.searchContainer.innerHTML = "\n                        <div class=\"col-sm-12\">\n                            No items found.\n                        </div>\n                        ";
                }
...
/* harmony import */ var _Elements_ProductSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Elements/ProductSlider */ "./resources/js/Elements/ProductSlider.js");
/* harmony import */ var _Elements_ProductSpinner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Elements/ProductSpinner */ "./resources/js/Elements/ProductSpinner.js");
/* harmony import */ var _Elements_CartMenuItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Elements/CartMenuItem */ "./resources/js/Elements/CartMenuItem.js");
/* harmony import */ var _Elements_AddToCart__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Elements/AddToCart */ "./resources/js/Elements/AddToCart.js");
/* harmony import */ var _Elements_Search__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Elements/Search */ "./resources/js/Elements/Search.js");
...
(0,_utils__WEBPACK_IMPORTED_MODULE_0__.documentReady)(function () {
  var search = new _Elements_Search__WEBPACK_IMPORTED_MODULE_5__["default"]();
  var searchOvelayBtn = document.querySelector('.show-search-panel-btn');
  searchOvelayBtn.addEventListener('click', function () {
    search.show();
  });
  new _Elements_ProductSlider__WEBPACK_IMPORTED_MODULE_1__["default"]();
  var cart = new _Elements_CartMenuItem__WEBPACK_IMPORTED_MODULE_3__["default"]();
  cart.syncCart();
  var addToCartProduct = new _Elements_AddToCart__WEBPACK_IMPORTED_MODULE_4__["default"]();
  var productDetailSpinner = document.getElementById('product-detail-spinner');
  var productSpinner = new _Elements_ProductSpinner__WEBPACK_IMPORTED_MODULE_2__["default"](productDetailSpinner); // Add To Cart 

  addToCartProduct.onProductAdded = function () {
    cart.syncCart();
    productSpinner.reset();
  };

  productSpinner.onValuesChanged = function (val) {
