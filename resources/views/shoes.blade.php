    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="{{ asset('images/shoes-img5.png') }}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('images/star-icon.png') }}"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="{{ asset('images/shoes-img6.png') }}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('images/star-icon.png') }}"></a></li>
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					...
    					<div class="shoes_icon"><img src="{{ asset('images/shoes-img7.png') }}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('images/star-icon.png') }}"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Sports Shoes</p>
    					<div class="shoes_icon"><img src="{{ asset('images/shoes-img8.png') }}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('images/star-icon.png') }}"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Sports Shoes</p>
    					<div class="shoes_icon"><img src="{{ asset('images/shoes-img9.png') }}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('images/star-icon.png') }}"></a></li>
